                ...
                <div className="flex-1 flex-center">
                  <p className=" feature-text g_text">
                    ...
                    <span className="text-white ">
                      the first iphone to feature an aerospace-grade titaniup
                      design
                    </span>{" "}
                    using the same alloy that spacecrafts use for mission ot
                    Mars
                  </p>
                </div>
                <div className="flex-1 flex-center">
                  <p className=" feature-text g_text">
                    ...
                    You notice the different the moment you pick one up
                  </p>
                </div>
              </div>
            </div>
